...
export const properties: Record<string, PropertyData> = {
  ...
  seabreeze: {
    slug: "seabreeze",
    name: "Seabreeze Shopping Center",
    tagline: "Your Neighborhood Shopping Destination",
    address: "30509 US Hwy 19 N",
    city: "Palm Harbor",
    state: "FL",
    zip: "34684",
    accentColor: "#0EA5E9",
    features: [
      { icon: "🛒", title: "Publix Anchored", description: "Full-service grocery with pharmacy" },
      { icon: "🍳", title: "Great Dining", description: "Popular breakfast & family restaurants" },
      { icon: "💇‍♀️", title: "Beauty Hub", description: "46+ salon & spa services" },
      { icon: "📍", title: "Convenient Location", description: "US Hwy 19 with easy access" },
    ],
    stats: [
      { label: "Total Businesses", value: "94+" },
      { label: "Anchor Tenant", value: "Publix" },
      { label: "Rating", value: "4.4★" },
    ],
    tenants: [
      { category: "🛒 Grocery", name: "Publix Super Market", description: "Full-service supermarket with bakery, deli & pharmacy", rating: 4.6, reviews: 1436 },
      { category: "🍳 Breakfast", name: "Keke's Breakfast Cafe", description: "Beloved breakfast spot with creative morning fare", rating: 4.9, reviews: 6860 },
      { category: "🍕 Italian", name: "Joey's New York Pizza", description: "Authentic New York style pizza & Italian cuisine", rating: 4.2, reviews: 1681 },
      { category: "💇‍♀️ Health & Beauty", name: "Multiple Salons & Spas", description: "Over 46 beauty service providers", rating: 4.4 },
      { category: "🏪 Services", name: "Various Services", description: "15+ professional service businesses" },
      { category: "🛍️ Shopping", name: "Retail Shops", description: "7 unique shopping destinations" },
    ],
    mapQuery: "30509+US+Hwy+19+N,+Palm+Harbor,+FL+34684",
  },
  palmharborshops: {
